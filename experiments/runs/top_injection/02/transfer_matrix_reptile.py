...
class TransferMatrix_ReRe:
    ...
    def plot_eigenvalues(self):
        # Compute eigenvalues
        num_eigenvalues = self.x_arr.size
        ...
        plt.title('Complex Eigenvalues and Unit Circle (ReRe)')
        plt.grid(True)
    ...
    def plot_evolution_pi(self, pi_init, Tf, freq=10):
        ...
        for n in range(1, Nt + 1):
            ...
            if n == count * interval:
                plt.plot(self.x_arr, pi_prod, label=f"t={n*ht:.2f}")
                count += 1
            
        # Plot formatting
        plt.xlabel("x")
        plt.ylabel(f"$\pi$(x,t)")
        plt.title(f"transform matrix evlove probability distribution (ReRe)")
        plt.legend()
        plt.grid(True)
        plt.show()
...
class TransferMatrix_AbRe:
    ...
    def plot_eigenvalues(self):
        ...
        plt.title('Complex Eigenvalues and Unit Circle (AbRe)')
        plt.grid(True)
        plt.axis('equal')  # Ensure aspect ratio is equal
        plt.legend()
        plt.show()
    ...
    def plot_evolution_pi(self, pi_init, Tf, freq=10):
        ...
        plt.xlabel("x")
        plt.ylabel(f"$\pi$(x,t)")
        plt.title(f"transform matrix evlove probability distribution (AbRe)")
        plt.legend()
        plt.grid(True)
        plt.show()
...
class TransferMatrix_AbAb:
    ...
    def plot_evolution_pi(self, pi_init, Tf, freq=10):
        ...
        plt.xlabel("x")
        plt.ylabel(f"$\pi$(x,t)")
        plt.title(f"transform matrix evlove probability distribution (AbAb)")
        plt.legend()
        plt.grid(True)
        plt.show()
...
class TransferMatrix_InReAb:
    ...
    def plot_evolution_pi(self, pi_init, Tf, freq=10):
        ...
        plt.xlabel("x")
        plt.ylabel(f"$\pi$(x,t)")
        plt.title(f"transform matrix evlove probability distribution (InReAb)")
        plt.legend()
        plt.grid(True)
        plt.show()
...
class TransferMatrix_AbReIn:
    ...
    def plot_evolution_pi(self, pi_init, Tf, freq=10):
        ...
        plt.xlabel("x")
        plt.ylabel(f"$\pi$(x,t)")
        plt.title(f"transform matrix evlove probability distribution (AbReIn)")
        plt.legend()
        plt.grid(True)
        plt.show()
